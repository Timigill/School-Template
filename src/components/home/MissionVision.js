...
export default function VisionMissionValues() {
    ...
    return (
        <section
            className="container-fluid p-5 bg-white position-relative"
            style={{
                color: "#01311f",
        ...
        >
            <AnimatedSection>
                <div className="text-center mb-2">
                    ...
                    <div className="mx-auto mt-4" style={{ width: '80px', height: '4px', background: '#ffc107', borderRadius: '2px' }}></div>
                </div>
            </AnimatedSection>

            {/* Vision & Mission */}
            <AnimatedSection delay={200}>
                <div className="row align-items-center mb-5 g-5 justify-content-center">
                    <div className="col-md-5 d-flex justify-content-md-end justify-content-center text-center mb-3 mb-md-0">
                        <div className="info-box p-3 rounded-4 shadow-sm bg-light border-0" style={{ maxWidth: '350px' }}>
                            <h4 className="fw-bold text-white py-2 rounded-3 text-uppercase letter-spacing-1"
                                style={{ background: "#01311f", letterSpacing: '2px', fontSize: '1.1rem' }}
                            >VISION</h4>
                            <p className="text-center mt-3 px-2" style={{ lineHeight: '1.6', fontSize: '0.8rem' }}>
                    ...
                    <div className="col-md-2 text-center mb-3 mb-md-0 d-flex justify-content-center">
                        <div className="image-wrapper p-2 rounded-circle d-inline-block">
                            <Image
                                src="/logo1.png"
                                alt="School Logo"
                                width={150}
                    ...
                    <div className="col-md-5 d-flex justify-content-md-start justify-content-center text-center mb-3 mb-md-0">
                        <div className="info-box p-3 rounded-4 shadow-sm bg-light border-0" style={{ maxWidth: '350px' }}>
                            <h4 className="fw-bold text-white py-2 rounded-3 text-uppercase letter-spacing-1"
                                style={{ background: "#01311f", letterSpacing: '2px', fontSize: '1.1rem' }}
                            >MISSION</h4>
