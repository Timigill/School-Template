          ...
          <Link href="/" className="navbar-brand d-flex align-items-center gap-2">
            ...
            <div className="d-flex flex-column">
              <div className="d-flex align-items-baseline">
                <span className="fw-bold text-uppercase" style={{ fontSize: '1.8rem', color: '#01311f' }}>
                  OXFORD
                </span>
                <span className="fw-bold text-uppercase ms-2" style={{ fontSize: '1.8rem', color: '#c6aa58' }}>
                  HOUSE SYSTEM
                </span>
              </div>
              <span className="text-uppercase" style={{ fontSize: '0.6rem', color: '#c6aa58' }}>
              ...
              {menuItems.map((item, index) => (
                <li key={index} className="nav-item dropdown position-static">
                  ...
                  {item.dropdown ? (
                    ...
                    <Link
                      href={item.path}
                      className={`nav-link px-3 py-2 fw-normal ${pathname === item.path ? 'text-warning fw-semibold' : 'text-dark'
                        }`}
                  ...
                  {item.dropdown && (
                    <ul
                      className={`dropdown-menu dropdown-menu-custom shadow border-0 mt-2 ${activeDropdown === item.title ? 'show' : ''
                        }`}
                    >
